  ...
  return (
    <>
      ...
      <div className='flex justify-between px-4 md:px-12'>
        ...
        <br />
      <p className='font-medium px-4 md:px-12'>Recent Classes</p>
      <br />
      <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8 px-4 md:px-12'>
        <div>
        ...
        <div>
          <img src={course2} alt="" className='rounded-lg' />
          <br />
          <p className='text-purple-600 text-sm mb-2'>Numeri Sattar Apar</p>
        ...
        <div>
          <img src={course3} alt="" className='rounded-lg' />
          <br />
          <p className='text-purple-600 text-sm mb-2'>Numeri Sattar Apar</p>
          <p>Math - Integration</p>
          <p className='text-gray-500 mt-2'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt nulla illo, dolores natus alias eligendi nisi eaque illum laborum consequatur!</p>
